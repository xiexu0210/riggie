...
public class EmailUtil {
    private static String fromEmail = "2638545848@qq.com";  // 发件人账号
    private static String fromEmailPw = "zxc779208";  // 发件人密码
    ...
    public void test() throws Exception {
        ...
        mailMessage.setTo("2638545848@qq.com");     //收件人
        mailMessage.setFrom("2638545848@qq.com");   //服务器   发件人
